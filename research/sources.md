...
**Source policy:** Prefer current primary agency, provider, or mission-owner pages. Use older pages only when a current page does not expose an important technical detail, and record the conflict in [assumptions.md](assumptions.md).

## NASA

1. [Moon Base phases](https://www.nasa.gov/moonbase-phases/) — Blue Moon Endurance, Griffin-1, IM-3, VIPER, CAPSTONE 02, Blue Ghost Mission 2, MoonFall, and Lunar Terrain Vehicles.
2. [Moon Base cargo landers and technology demonstrations](https://www.nasa.gov/missions/moon-base/nasa-provides-updates-on-moon-base-cargo-landers-tech-demonstrations/) — current Phase One framing, commercial lander progress, and Northrop Grumman demonstration payloads.
3. [Artemis program](https://www.nasa.gov/humans-in-space/artemis/) — current Artemis III, IV, and V architecture and dates.
4. [CAPSTONE 02](https://www.nasa.gov/directorates/rtmd/nasa-announces-new-spacecraft-technology-demonstration-mission-at-moon/) — 2027 two-spacecraft orbital demonstration.
5. [CLPS providers](https://www.nasa.gov/commercial-lunar-payload-services/clps-providers/) — legacy provider and task-order details, including Draper CP-12.
6. [FY2027 budget request](https://www.nasa.gov/wp-content/uploads/2026/04/fiscal-year-2027-full-budget-request.pdf) — LASSO and related lunar technology-planning references.
7. [Farside Seismic Suite](https://www.jpl.nasa.gov/missions/farside-seismic-suite/) — Schrödinger Basin and seismic payload context.
8. [VIPER mission status](https://science.nasa.gov/mission/viper/) — cancellation history and continuing partnership/alternative-delivery context.

## Commercial providers

9. [Firefly Blue Ghost Mission 2](https://fireflyspace.com/missions/blue-ghost-mission-2/) — Blue Ghost, Elytra Dark, Lunar Pathfinder, Rashid Rover 2, far-side location, and payloads.
10. [Astrobotic lunar manifest](https://www.astrobotic.com/lunar-delivery/manifest/) — Griffin-1 and FLIP manifest details.
11. [Intuitive Machines IM-3](https://www.intuitivemachines.com/missions/lunar/im-3-mission) — Trinity, Reiner Gamma, payloads, and Altus-1 relay context.
12. [Intuitive Machines IM-4 announcement](https://investors.intuitivemachines.com/news-releases/news-release-details/intuitive-machines-selects-spacex-launch-its-fourth-lunar-lander) — 2027 IM-4 and polar drill suite.
13. [Blue Origin Blue Moon MK1](https://www.blueorigin.com/blue-moon/mark-1) — MK1 lander role, cargo architecture, and Pathfinder mission description.
